        ...
        <div class="col-md-4" style="margin-top: 25px">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text text-muted"> Artículos vendidos:` + " " + product.soldCount + `</p>
                    <a href="product-info.html?producto=` + product.name + `" class="btn btn-primary">Ver más detalles</a>
                </div>
            </div>
        </div>
        `;
